...
export default function BookCard({ book }) {
  function handleAddToOrder(e) {
    ...
    ordersAPI.addBookToCart(book.volumeInfo).then((res) => {console.log(res)});
  }
  ...
  // Check if the price is manually set
  const isManuallySetPrice =
    listPrice !== undefined || retailPrice !== undefined;
    ...
    <form>
      <div className="max-w-xs mb-4 transition duration-300 transform hover:scale-105">
        ...
        <div className="px-4 py-2 bg-gray-100 rounded-b">
          ...
          {isManuallySetPrice && ( // Display "50% off" label only if price is manually set
            <p className="text-red-500 text-xs mb-1">50% off</p>
          )}
          <button
